...
public class BitBufferHelperTest {
    ...
    public void testGetBits() throws Exception {
        ...
        bits = BitBufferHelper.getBits(data, 88, 8); // BYTE extraOffsetBits =
                                                     // extranumBits = 0
        ...
        bits = BitBufferHelper.getBits(data, 40, 7); // BYTE extraOffsetBits =
                                                     // extranumBits != 0
        ...
        bits = BitBufferHelper.getBits(data, 3, 7); // BYTE extraOffsetBits !=
                                                    // 0; extranumBits == 0
        ...
        bits = BitBufferHelper.getBits(data, 66, 9); // BYTE extraOffsetBits !=
                                                     // 0; extranumBits != 0
        Assert.assertTrue(bits[0] == 1);
