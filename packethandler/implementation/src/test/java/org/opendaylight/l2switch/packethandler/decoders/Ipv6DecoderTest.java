...
class Ipv6DecoderTest {
    ...
    void testToString() {
        assertEquals("""
            Ipv6Decoder{consumes=org.opendaylight.yang.gen.v1.urn.opendaylight.packet.ethernet.rev140528.\
            EthernetPacketReceived, produces=org.opendaylight.yang.gen.v1.urn.opendaylight.packet.ipv6.rev140528.\
            Ipv6PacketReceived}""", ipv6Decoder.toString());
    }
