...
class Ipv6DecoderTest {
    ...
    void testDecode_ExtensionHeader() {
        ...
        assertArrayEquals(Arrays.copyOfRange(payload, 56, 62), ipv6Packet.getExtensionHeaders().get(0).getData());
        assertEquals(54, ipv6Packet.getPayloadOffset().intValue());
    ...
    void testDecode_ExtensionHeaders() {
        ...
        assertArrayEquals(Arrays.copyOfRange(payload, 64, 70), ipv6Packet.getExtensionHeaders().get(1).getData());
        assertEquals(54, ipv6Packet.getPayloadOffset().intValue());
