...
class IcmpDecoderTest {
    ...
    void testToString() {
        assertEquals("""
            IcmpDecoder{consumes=org.opendaylight.yang.gen.v1.urn.opendaylight.packet.ipv4.rev140528.\
            Ipv4PacketReceived, produces=org.opendaylight.yang.gen.v1.urn.opendaylight.packet.icmp.rev140528.\
            IcmpPacketReceived}""", icmpDecoder.toString());
    }
