...
public class NetUtilsTest {
    ...
    public void testByteArrayMethods() {
        int ip = 8888;
        Assert.assertTrue(NetUtils.byteArray4ToInt(NetUtils.intToByteArray4(ip)) == ip);
        ...
        Assert.assertTrue(Arrays.equals(ba, NetUtils.intToByteArray4(NetUtils.byteArray4ToInt(ba))));

        byte ba1[] = { (byte) 255, (byte) 255, (byte) 255, (byte) 255 };
        Assert.assertTrue(Arrays.equals(ba1, NetUtils.intToByteArray4(NetUtils.byteArray4ToInt(ba1))));

        byte ba2[] = { (byte) 255, (byte) 0, (byte) 0, (byte) 0 };
        Assert.assertTrue(Arrays.equals(ba2, NetUtils.intToByteArray4(NetUtils.byteArray4ToInt(ba2))));

        byte ba3[] = { (byte) 0, (byte) 0, (byte) 0, (byte) 0 };
        Assert.assertTrue(Arrays.equals(ba3, NetUtils.intToByteArray4(NetUtils.byteArray4ToInt(ba3))));

        byte ba4[] = { (byte) 255, (byte) 128, (byte) 0, (byte) 0 };
        Assert.assertTrue(Arrays.equals(ba4, NetUtils.intToByteArray4(NetUtils.byteArray4ToInt(ba4))));
    }
    ...
    public void testByteArrayMethodsForLong() {
        ...
        Assert.assertTrue(NetUtils.byteArray6ToLong(NetUtils.longToByteArray6(mac)) == mac);

        Assert.assertTrue(NetUtils.byteArray6ToLong(NetUtils.longToByteArray6(mac1)) == mac1);

        Assert.assertTrue(NetUtils.byteArray6ToLong(NetUtils.longToByteArray6(mac2)) == mac2);

        Assert.assertTrue(NetUtils.byteArray6ToLong(NetUtils.longToByteArray6(mac3)) == mac3);

        Assert.assertTrue(NetUtils.byteArray6ToLong(NetUtils.longToByteArray6(mac4)) == mac4);

        // Convert a byte array to a long nubmer,
        // and revert it to the byte array again.
        Assert.assertTrue(Arrays.equals(ba, NetUtils.longToByteArray6(NetUtils.byteArray6ToLong(ba))));

        Assert.assertTrue(Arrays.equals(ba1, NetUtils.longToByteArray6(NetUtils.byteArray6ToLong(ba1))));

        Assert.assertTrue(Arrays.equals(ba2, NetUtils.longToByteArray6(NetUtils.byteArray6ToLong(ba2))));

        Assert.assertTrue(Arrays.equals(ba3, NetUtils.longToByteArray6(NetUtils.byteArray6ToLong(ba3))));

        Assert.assertTrue(Arrays.equals(ba4, NetUtils.longToByteArray6(NetUtils.byteArray6ToLong(ba4))));
    ...
    public void testGetSubnetPrefix() throws UnknownHostException {
        ...
        int maskLen = 25;
        Assert.assertTrue(NetUtils.getSubnetPrefix(ip, maskLen).equals(InetAddress.getByName("192.128.64.128")));
    }

    @Test
    public void testIsIPv6Valid() throws UnknownHostException {
        Assert.assertTrue(NetUtils.isIPv6AddressValid("fe80:0000:0000:0000:0204:61ff:fe9d:f156")); // normal
                                                                                                   // ipv6
        Assert.assertTrue(NetUtils.isIPv6AddressValid("fe80:0:0:0:204:61ff:fe9d:f156")); // no
                                                                                         // leading
                                                                                         // zeroes
        Assert.assertTrue(NetUtils.isIPv6AddressValid("fe80::204:61ff:fe9d:f156")); // zeroes
                                                                                    // to
                                                                                    // ::
        Assert.assertTrue(NetUtils.isIPv6AddressValid("fe80:0000:0000:0000:0204:61ff:254.157.241.86")); // ipv4
                                                                                                        // ending
        Assert.assertTrue(NetUtils.isIPv6AddressValid("fe80:0:0:0:0204:61ff:254.157.241.86")); // no
                                                                                               // leading
                                                                                               // zeroes,
                                                                                               // ipv4
                                                                                               // end
        Assert.assertTrue(NetUtils.isIPv6AddressValid("fe80::204:61ff:254.157.241.86")); // zeroes
                                                                                         // ::,
                                                                                         // no
                                                                                         // leading
                                                                                         // zeroes

        Assert.assertTrue(NetUtils.isIPv6AddressValid("2001::")); // link-local
                                                                  // prefix
        ...
        Assert.assertFalse(NetUtils.isIPv6AddressValid("fe80:0:0:0:204:61ff:fe9d")); // not
                                                                                     // valid,
                                                                                     // too
                                                                                     // short
        Assert.assertFalse(NetUtils.isIPv6AddressValid("fe80:::0:0:0:204:61ff:fe9d")); // not
                                                                                       // valid
        Assert.assertFalse(NetUtils.isIPv6AddressValid("192.168.1.1")); // not
                                                                        // valid,ipv4
        Assert.assertFalse(NetUtils.isIPv6AddressValid("2001:0000:1234:0000:10001:C1C0:ABCD:0876")); // not
                                                                                                     // valid,
                                                                                                     // extra
                                                                                                     // number
        Assert.assertFalse(NetUtils.isIPv6AddressValid("20010:0000:1234:0000:10001:C1C0:ABCD:0876")); // not
                                                                                                      // valid,
                                                                                                      // extra
                                                                                                      // number

        Assert.assertTrue(NetUtils.isIPv6AddressValid("2001:0DB8:0000:CD30:0000:0000:0000:0000/60")); // full
                                                                                                      // with
                                                                                                      // mask
        Assert.assertTrue(NetUtils.isIPv6AddressValid("2001:0DB8:0:CD30::/64")); // shortened
                                                                                 // with
                                                                                 // mask
        Assert.assertTrue(NetUtils.isIPv6AddressValid("2001:0DB8:0:CD30::/0")); // 0
                                                                                // subnet
                                                                                // with
                                                                                // mask
        Assert.assertTrue(NetUtils.isIPv6AddressValid("::1/128")); // localhost
                                                                   // 128 mask

        Assert.assertFalse(NetUtils.isIPv6AddressValid("124.15.6.89/60")); // invalid,
                                                                           // ip
                                                                           // with
                                                                           // mask
        Assert.assertFalse(NetUtils.isIPv6AddressValid("2001:0DB8:0000:CD30:0000:0000:0000:0000/130")); // invalid,
                                                                                                        // mask
                                                                                                        // >128
        Assert.assertFalse(NetUtils.isIPv6AddressValid("2001:0DB8:0:CD30::/-5")); // invalid,
                                                                                  // mask
                                                                                  // <
                                                                                  // 0
        Assert.assertFalse(NetUtils.isIPv6AddressValid("fe80:::0:0:0:204:61ff:fe9d/64")); // not
                                                                                          // valid
                                                                                          // ip,
                                                                                          // valid
                                                                                          // netmask
        Assert.assertFalse(NetUtils.isIPv6AddressValid("fe80:::0:0:0:204:61ff:fe9d/-1")); // not
                                                                                          // valid
                                                                                          // both
    ...
    public void testInetAddressConflict() throws UnknownHostException {
        ...
        Assert.assertFalse(NetUtils.inetAddressConflict(InetAddress.getByName("9.9.1.1"),
        ...
        Assert.assertTrue(NetUtils.inetAddressConflict(InetAddress.getByName("9.9.2.1"),
                InetAddress.getByName("9.9.1.0"), null, InetAddress.getByName("255.255.255.0")));
    ...
    public void testIPAddressValidity() {
        ...
        Assert.assertTrue(NetUtils.isIPAddressValid("2001:420:281:1004:407a:57f4:4d15:c355"));
    }
