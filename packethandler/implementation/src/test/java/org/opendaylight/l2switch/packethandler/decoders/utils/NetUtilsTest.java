...
public class NetUtilsTest {
    ...
    public void testIsIPv6Valid() throws UnknownHostException {
        Assert.assertTrue(NetUtils.isIPv6AddressValid("fe80:0000:0000:0000:0204:61ff:fe9d:f156")); // normal ipv6
        Assert.assertTrue(NetUtils.isIPv6AddressValid("fe80:0:0:0:204:61ff:fe9d:f156")); // no leading zeroes
        Assert.assertTrue(NetUtils.isIPv6AddressValid("fe80::204:61ff:fe9d:f156")); // zeroes to ::
        Assert.assertTrue(NetUtils.isIPv6AddressValid("fe80:0000:0000:0000:0204:61ff:254.157.241.86")); // ipv4 ending
        Assert.assertTrue(NetUtils.isIPv6AddressValid("fe80:0:0:0:0204:61ff:254.157.241.86")); // no leading zeroes, ipv4 end
        Assert.assertTrue(NetUtils.isIPv6AddressValid("fe80::204:61ff:254.157.241.86")); // zeroes ::, no leading zeroes
        ...
        Assert.assertFalse(NetUtils.isIPv6AddressValid("fe80:0:0:0:204:61ff:fe9d")); // not valid, too short
        Assert.assertFalse(NetUtils.isIPv6AddressValid("fe80:::0:0:0:204:61ff:fe9d")); // not valid
        Assert.assertFalse(NetUtils.isIPv6AddressValid("192.168.1.1")); // not valid,ipv4
        Assert.assertFalse(NetUtils.isIPv6AddressValid("2001:0000:1234:0000:10001:C1C0:ABCD:0876")); // not valid, extra number
        Assert.assertFalse(NetUtils.isIPv6AddressValid("20010:0000:1234:0000:10001:C1C0:ABCD:0876")); // not valid, extra number

        Assert.assertTrue(NetUtils.isIPv6AddressValid("2001:0DB8:0000:CD30:0000:0000:0000:0000/60")); // full with mask
        ...
        Assert.assertFalse(NetUtils.isIPv6AddressValid("2001:0DB8:0000:CD30:0000:0000:0000:0000/130")); // invalid, mask >128
        Assert.assertFalse(NetUtils.isIPv6AddressValid("2001:0DB8:0:CD30::/-5")); // invalid, mask < 0
        Assert.assertFalse(NetUtils.isIPv6AddressValid("fe80:::0:0:0:204:61ff:fe9d/64")); // not valid ip, valid netmask
        Assert.assertFalse(NetUtils.isIPv6AddressValid("fe80:::0:0:0:204:61ff:fe9d/-1")); // not valid both
