...
final class PacketListener<C extends Notification<C> & DataObject, P extends Notification<P> & DataObject>
    ...
    private final @NonNull NotificationPublishService notificationProviderService;
    ...
    PacketListener(final NotificationPublishService notificationProviderService,
...
//  }
    ...
    public void onNotification(final C notification) {
        ...
        try {
            notificationProviderService.putNotification(decoded);
