...
public class NetworkGraphImplTest {
    ...
    public void testRemoveLinks_ValidInput() throws Exception {
        ...
        Link link3 = new LinkBuilder().setLinkId(new LinkId("openflow:3"))
                .setSource(new SourceBuilder().setSourceNode(new NodeId("openflow:3"))
                        .setSourceTp(new TpId("openflow:3")).build())
    ...
    public void testMstRemovesLoops() throws Exception {
        ...
        Link link7 = new LinkBuilder().setLinkId(new LinkId("openflow:1:3"))
                .setSource(new SourceBuilder().setSourceNode(new NodeId("openflow:1"))
                        .setSourceTp(new TpId("openflow:1:3")).build())
                .setDestination(new DestinationBuilder().setDestNode(new NodeId("openflow:2"))
                        .setDestTp(new TpId("openflow:2:3")).build())
                .build();
