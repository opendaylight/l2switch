...
/**
 * Ipv4PacketProvider serves as the Activator for our Ipv4Packet OSGI bundle.
 */
public class Ipv4PacketProvider extends AbstractBindingAwareConsumer
    implements AutoCloseable {

  private final static Logger _logger = LoggerFactory.getLogger(Ipv4PacketProvider.class);
