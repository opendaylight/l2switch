...
public class SimpleAddressObserver implements NotificationService.Listener<EthernetPacketReceived> {
    ...
    public void onArpPacketReceived(RawPacketFields rawPacket, EthernetPacket ethernetPacket,
                                    ArpPacket arpPacket) {
        VlanId vlanId = null;
    ...
    public void onIpv4PacketReceived(RawPacketFields rawPacket, EthernetPacket ethernetPacket,
    ...
    public void onIpv6PacketReceived(RawPacketFields rawPacket, EthernetPacket ethernetPacket,
