...
public class Ipv4Decoder implements PacketDecoder {
  ...
  public Packet decode(Packet packet) {
      ...
      try {
          ...
          builder.setDscp(new Dscp(BitBufferHelper.getShort(BitBufferHelper.getBits(data, 8, 6))));
          ...
          builder.setSourceIpv4(new Ipv4Address(InetAddress.getByAddress(BitBufferHelper.getBits(data, 96, 32)).getHostAddress()));
          builder.setDestinationIpv4(new Ipv4Address(InetAddress.getByAddress(BitBufferHelper.getBits(data, 128, 32)).getHostAddress()));
