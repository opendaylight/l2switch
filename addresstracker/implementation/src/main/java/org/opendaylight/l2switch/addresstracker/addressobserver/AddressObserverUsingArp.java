...
public class AddressObserverUsingArp implements Listener<ArpPacketReceived> {
    ...
    public AddressObserverUsingArp(final AddressObservationWriter addressObservationWriter) {
     ...
     */
    @Override
    public void onNotification(final ArpPacketReceived packetReceived) {
