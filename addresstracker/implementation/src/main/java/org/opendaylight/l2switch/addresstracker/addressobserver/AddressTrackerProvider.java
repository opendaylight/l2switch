...
public class AddressTrackerProvider {
    ...
    public AddressTrackerProvider(final DataBroker dataBroker, final NotificationProviderService notificationProviderService, final AddressTrackerConfig config) {
