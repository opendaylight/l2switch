...
public class AddressObserverUsingIpv6Test {
    ...
    public void onIpv6PacketReceivedTest() {
        ...
        packetChainList.add(new PacketChainBuilder()
                ...
                .build());
        packetChainList
                .add(new PacketChainBuilder()
                        .setPacket(new Ipv6PacketBuilder()
                                .setSourceIpv6(new Ipv6Address("123:4567:89ab:cdef:fedc:ba98:7654:3210")).build())
                        .build());
    ...
    public void onIpv6PacketReceivedNullInputTest3() throws Exception {
        ...
        packetChainList.add(new PacketChainBuilder()
                ...
                .build());
        packetChainList.add(new PacketChainBuilder()
                .setPacket(new Ipv6PacketBuilder().setSourceIpv6(new Ipv6Address("0:0:0:0:0:0:0:0")).build()).build());
